...
ifneq ($(TARGET_FUSION_KERNEL),)
  ifeq ($(HOST_OS),darwin)
    KERNEL_CROSS_COMPILE := CROSS_COMPILE="$(ANDROID_BUILD_TOP)/prebuilts/gcc/darwin-x86/arm/arm-eabi-$(TARGET_FUSION_KERNEL)/bin/arm-eabi-"
  else
    KERNEL_CROSS_COMPILE := CROSS_COMPILE="$(ANDROID_BUILD_TOP)/prebuilts/gcc/linux-x86/arm/arm-eabi-$(TARGET_FUSION_KERNEL)/bin/arm-eabi-"
  endif
else
